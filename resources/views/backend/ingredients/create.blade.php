...
@section('title','Folafol BD - Add New Ingredient')

@section('dashboard_content')
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Add New Ingredient</h4>
        <p class="text-muted">Create a new ingredient for your juice shop</p>
    </div>
    <div>
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.ingredients.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('current_stock') is-invalid @enderror" id="current_stock" name="current_stock" value="{{ old('current_stock', 0) }}" step="0.01" min="0" required>
                            @error('current_stock')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('minimum_stock') is-invalid @enderror" id="minimum_stock" name="minimum_stock" value="{{ old('minimum_stock', 0) }}" step="0.01" min="0" required>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-success me-2">Save Ingredient</button>
        ...
        $('#image').on('change', function() {
            ...
            reader.onload = (e) => {
                if (!$('#preview-container').length) {
                    $('<div id="preview-container" class="mt-2"><label class="form-label">Image Preview:</label><div><img id="preview-image" class="img-thumbnail" style="max-height: 150px;"></div></div>').insertAfter('#image');
                }
