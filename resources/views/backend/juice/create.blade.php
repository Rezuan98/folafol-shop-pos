                ...
                <form action="{{ route('admin.juices.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="price_small" name="price_small" value="{{ old('price_small') }}" step="0.01" min="0">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="price_medium" class="form-label">Medium Size Price (৳)</label>
                            <input type="number" class="form-control" id="price_medium" name="price_medium" value="{{ old('price_medium') }}" step="0.01" min="0">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="price_large" class="form-label">Large Size Price (৳)</label>
                            <input type="number" class="form-control" id="price_large" name="price_large" value="{{ old('price_large') }}" step="0.01" min="0">
                        </div>
                    </div>
